...
#+NAME: drop-test
#+BEGIN_SRC ipython :session :exports both :results raw drawer :var dpdk_data=dpdk_test2[,0:1] :var xdp_data=xdp_drop_data_jdb01
...
:results:
# Out[36]:
[[file:./obipy-resources/wbHjO3.svg]]
:end:
