...
The interface is running the 'xdp1' sample program.
...
:results:
# Out[24]:
[[file:./obipy-resources/lHDMuO.svg]]
:end:
...
plt.ylim(0,110)
plt.xlim(0,27)
plt.savefig(BASEDIR+"/figures/drop-cpu.pdf")
plt.show()
#+END_SRC
...
:results:
# Out[53]:
[[file:./obipy-resources/GwfkG9.svg]]
:end:
...
:results:
# Out[20]:
[[file:./obipy-resources/xrgN19.svg]]
:end:
