...
#+NAME: drop-test
#+BEGIN_SRC ipython :session :exports both :results raw drawer :var dpdk_data=dpdk_test2[,0:1] :var xdp_data=xdp_drop_data_jdb01 :var linux_data=linux_iptables_drop
...
:results:
# Out[45]:
[[file:./obipy-resources/2RJuv4.svg]]
:end:
