...
** TODO Get real results for XDP_DROP 2-5 cores

** XDP_DROP per number of queues

These are from Jesper's initial runs.
...
:results:
# Out[94]:
: <matplotlib.legend.Legend at 0x7f2fa3466b38>
[[file:./obipy-resources/4cm34n.svg]]
:end:
