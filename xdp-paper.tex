...
% FIXME: We switch between figures 1 and 2 here; move fig 2 to the beginning and
% refer to both at once
...
\begin{itemize}
\item Maximum packet processing performance. We install a simple XDP program
  that drops packets after receiving them.
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{figures/xdp-baseline.pdf}
\caption{\label{fig:xdp-baseline} Baseline XDP performance.}
\end{figure}
