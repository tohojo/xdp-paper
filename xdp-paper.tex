...
hardware. Amortising these costs over multiple packets through batching is an
essential technique to achieve high performance. In Linux, there are two main
ways batching is achieved: On the receive path, the NAPI mechanism~\cite{napi}
