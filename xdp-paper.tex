...
project~\cite{p4xdp}.
%
% Mention OVS patches using AF_XDP by William Tu (VMware) ?
%
% Mention DPDK PMD (Poll Mode Driver) using AF_XDP ?
%  http://mails.dpdk.org/archives/dev/2018-February/091502.html
...
dedicating whole NIC plus CPU cores to packet processing.
