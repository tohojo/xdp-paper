...
% Detail: Helper calls are not callbacks and not indirect-function
% pointer calls (thus not affected by retpoline)
%
% The verifier translates helper ID numbers into real kernel function calls
% (change insn->imm = bpf_func_proto->func).
