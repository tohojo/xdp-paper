...
\begin{abstract}
  ...
  overcoming these limitations, where the kernel itself provides a safe execution
  environment for custom high-performance packet processing applications,
  executed in the context of the kernel device driver. This system, called the
  eXpress Data Path (XDP), has recently been merged as part of the mainline
  Linux kernel, and got gradually expanded over the last releases. In XDP,
