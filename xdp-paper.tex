...
\label{sec:orgf329a18}
High-performance packet processing in software has very tight bounds on the time
spent processing each packet (\textasciitilde{}67 ns per packet at 10 Gbps). Network stacks in
...
\label{sec:orgb95dfdb}
\section{The design of XDP}
\label{sec:org9f28e58}
