...
% FIXME: EXPLAIN MORE ... ran out of time...
...
two Mellanox ConnectX-5 Ex VPI dual-port 100Gbps network adapters. We use the
TRex packet generator~\cite{cisco18:_trex_traff_gener} to produce the test
traffic. The test machine runs a version of the Linux kernel that will be
released as v4.18. The needed XDP redirect changes to NIC driver mlx5 is
expected to appear in v4.19.
